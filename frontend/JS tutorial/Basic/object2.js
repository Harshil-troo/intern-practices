...
//discount,selling function return selling price
...
//function ProductConstructor(ProductName,
//Price,Quantity,Discount){
//    this.ProductName = ProductName
//    this.Price = Price
//    this.Quantity = Quantity
//    this.Discount = Discount
//    this.SellingPrice = Price-(this.Price*(this.Discount/100));
//}
...
for(let i = 0; i<myobj.results.length;i++)
{
    ...
    createElement("li");
    listItem.textContent = myobj.results
    [i].definition;
